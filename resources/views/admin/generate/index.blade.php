        ...
        <div class="card-body">
          <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="d-flex gap-2">
              ...
              <a href="{{ route('generate-id.create') }}" class="btn btn-primary">
                <i class="bi bi-plus-circle me-1"></i>
                Add
              </a>
            </div>
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex gap-1">
                      <a href="{{ route('generate-id.edit', $entry->id) }}" class="btn btn-sm btn-primary" title="Edit">
                        <i class="bi bi-pencil-square"></i>
                      </a>
                      <a href="{{ route('generate-id.show', $entry->id) }}" class="btn btn-sm btn-info text-white" title="View">
                        <i class="bi bi-eye"></i>
                      </a>
                    </div>
                  </td>
